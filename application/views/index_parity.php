                               ...
                               <div class="balance_content">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-5 text-center">
                                            <button type="button" class="btn btn-success balance_btn">Recharge</button><br>
                            ...
                            <div class="full_content">
                                 <div class="row">
                                   ...
                                   <div class="icon_color">
                                       <h3 class="font_size"><i class="fa fa-clock-o" aria-hidden="true"></i>Period</h3>
                                ...
                                <div class="row d-flex justify-content-around" style="margin-right:1%;margin-left: -17px;">
                                   <div class="col-md-2 col-2">
                                       <button type="button" class="red_btn padding_btnM">0</button>
                                   </div>
                                    <div class="col-md-2 col-2">
                                ...
                                <div class="row d-flex justify-content-around" style="margin-right:1%;margin-left: -17px;">
                                   <div class="col-md-2 col-2">
                                       <button type="button" class="green_btn padding_btn">5</button>
                                   </div>
                                    <div class="col-md-2 col-2">
                                ...
                                <div class="row">
                                   <div class="col-md-6 col-6">
                                   <div class="icon_color">
                                       <h3 class="font_size2 green">Fast Parity Records</h3>
                                    </div>
                                  </div>
                                    <div class="col-md-6 col-6">
                                    <div class="icon_color">
                             ...
                             <div class="card card_shadow">
                               ...
                               <div class="row">
                                   <div class="col-md-12 col-12">
                                     <div class="icon_color">
                                       <h3 class="font_size2 green">My Fast Parity Records</h3>
                                    </div>
                                  </div>
                                </div>
<hr>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4 col-4 balance_fontweight">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Select : Red</h3>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-8 col-8 balance_fontweight">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Status : <span class="win_span">Win</span> </h3>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-4 balance_fontweight">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Result : <span class="red_span">2, red</span></h3>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-8 col-8 balance_fontweight">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Open Time : 16:18:25 </h3>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-4 balance_fontweight">
                                     <div class="icon_color">
                                ...
                                <div class="row">
                                   <div class="col-md-8 col-8 balance_fontweight">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Status : Win</h3>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-4 balance_fontweight">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Result : <span class="win_span">8, Green</span></h3>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-8 col-8 balance_fontweight">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Open Time : 15:25:25  </h3>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-4 balance_fontweight">
                                     <div class="icon_color">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4 col-4 balance_fontweight" style="border-bottom:2px solid green">
                                     <div class="icon_color">
                                       <h3 class="font_size3">Amount :100</h3>
                                    </div>
                                  </div>
                                </div>
